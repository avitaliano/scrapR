...
################
# constantes
download_dir <- "scrapVivaReal/data"
url_base <- "https://www.vivareal.com.br"

url_anuncios <- c("https://www.vivareal.com.br/aluguel/sp/sao-paulo/zona-sul/paraiso/?__vt=afs:a#area-desde=60&onde=BR-Sao_Paulo-NULL-Sao_Paulo-Zona_Sul-Paraiso&preco-ate=4000&preco-total=sim&quartos=2&vagas=1")
